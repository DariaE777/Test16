                ...
                if (result) {
                    ...
                    this.quiz.questions.forEach((question, index) => {
                        ...
                        question.answers.forEach(answer => {
                            stringAnswers += answer.id + ',';
                        });
                        if (this.userResult[index]) {
                            sessionStorage.setItem(index, stringAnswers +
                                (this.userResult[index].chosenAnswerId ? this.userResult[index].chosenAnswerId : ''));
                        } else {
                            sessionStorage.setItem(index, stringAnswers + '');
                        }
                    });
                    location.href = 'result.html?id=' + id + '&score=' + result.score +
                        '&total=' + result.total + '&name=' + name +
